...
func TestIspProceduresMapped(t *testing.T) {
	required := []string{
		...
		"/polyglot.v1.BillingService/CancelInvoice",
		...
		"/polyglot.v1.IspAdminService/PullRouterPlans",
		"/polyglot.v1.IspAdminService/CommitPlans",
		"/polyglot.v1.IspAdminService/PullRouterCustomers",
		"/polyglot.v1.IspAdminService/CommitCustomers",

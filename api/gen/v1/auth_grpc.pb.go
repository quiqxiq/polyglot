...
const (
	AuthService_Login_FullMethodName          = "/polyglot.v1.AuthService/Login"
	AuthService_GetMe_FullMethodName          = "/polyglot.v1.AuthService/GetMe"
	AuthService_UpdateMe_FullMethodName       = "/polyglot.v1.AuthService/UpdateMe"
	AuthService_ChangePassword_FullMethodName = "/polyglot.v1.AuthService/ChangePassword"
	AuthService_RefreshToken_FullMethodName   = "/polyglot.v1.AuthService/RefreshToken"
	AuthService_Logout_FullMethodName         = "/polyglot.v1.AuthService/Logout"
)
...
func (c *authServiceClient) UpdateMe(ctx context.Context, in *UpdateMeRequest, opts ...grpc.CallOption) (*UpdateMeResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) UpdateMe(context.Context, *UpdateMeRequest) (*UpdateMeResponse, error) {

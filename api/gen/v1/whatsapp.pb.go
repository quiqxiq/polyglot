...
const file_v1_whatsapp_proto_rawDesc = "" +
	"\n" +
	"\x11v1/whatsapp.proto\x12\vpolyglot.v1\x1a\x1bbuf/validate/validate.proto\"\xe2\x01\n" +
	"\tWASession\x12\x0e\n" +
	...
	"\bsessions\x18\x01 \x03(\v2\x16.polyglot.v1.WASessionR\bsessions\"X\n" +
	"\x16CreateWASessionRequest\x12\x1b\n" +
	"\x04name\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04name\x12!\n" +
	"\fphone_number\x18\x02 \x01(\tR\vphoneNumber\"K\n" +
	"\x17CreateWASessionResponse\x120\n" +
	"\asession\x18\x01 \x01(\v2\x16.polyglot.v1.WASessionR\asession\"?\n" +
	"\x15GetWASessionQRRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\"\x8b\x01\n" +
	"\x16GetWASessionQRResponse\x12$\n" +
	"\x0eqr_code_base64\x18\x01 \x01(\tR\fqrCodeBase64\x12 \n" +
	"\fqr_code_path\x18\x02 \x01(\tR\n" +
	"qrCodePath\x12)\n" +
	"\x10duration_seconds\x18\x03 \x01(\x05R\x0fdurationSeconds\"p\n" +
	"\x1aGetWASessionPairingRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\x12*\n" +
	"\fphone_number\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vphoneNumber\"@\n" +
	"\x1bGetWASessionPairingResponse\x12!\n" +
	"\fpairing_code\x18\x01 \x01(\tR\vpairingCode\"Y\n" +
	"\x12ToggleWABotRequest\x12&\n" +
	"\n" +
	...
	"\x19ReconnectWASessionRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\"N\n" +
	"\x1aReconnectWASessionResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\"@\n" +
	"\x16LogoutWASessionRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\"3\n" +
	"\x17LogoutWASessionResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"?\n" +
	"\x15PurgeWASessionRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\"2\n" +
	"\x16PurgeWASessionResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\xa0\x01\n" +
	"\x18SendWATextMessageRequest\x12&\n" +
	"\n" +
	...
	"\fmessage_text\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\vmessageText\"R\n" +
	...
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\x12\"\n" +
	"\bchat_jid\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\achatJid\x12\x14\n" +
	...
	"\x13MarkChatReadRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\x12\"\n" +
	"\bchat_jid\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\achatJid\"0\n" +
	"\x14MarkChatReadResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\x7f\n" +
	"\x14ToggleChatBotRequest\x12&\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\tsessionId\x12\"\n" +
	"\bchat_jid\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\achatJid\x12\x1b\n" +

...
func (c *userServiceClient) ToggleActive(ctx context.Context, in *ToggleActiveRequest, opts ...grpc.CallOption) (*ToggleActiveResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedUserServiceServer) ToggleActive(context.Context, *ToggleActiveRequest) (*ToggleActiveResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ToggleActive not implemented")
}

...
const file_v1_rbac_proto_rawDesc = "" +
	"\n" +
	"\rv1/rbac.proto\x12\vpolyglot.v1\x1a\x1bbuf/validate/validate.proto\">\n" +
	"\x06Policy\x12\x10\n" +
	...
	"\bpolicies\x18\x01 \x03(\v2\x13.polyglot.v1.PolicyR\bpolicies\"G\n" +
	"\x10AddPolicyRequest\x123\n" +
	"\x06policy\x18\x01 \x01(\v2\x13.polyglot.v1.PolicyB\x06\xbaH\x03\xc8\x01\x01R\x06policy\"-\n" +
	"\x11AddPolicyResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"J\n" +
	"\x13RemovePolicyRequest\x123\n" +
	"\x06policy\x18\x01 \x01(\v2\x13.polyglot.v1.PolicyB\x06\xbaH\x03\xc8\x01\x01R\x06policy\"0\n" +
	...
	"\x10role_assignments\x18\x01 \x03(\v2\x1b.polyglot.v1.RoleAssignmentR\x0froleAssignments\"X\n" +
	"\x11AssignRoleRequest\x12C\n" +
	"\n" +
	"assignment\x18\x01 \x01(\v2\x1b.polyglot.v1.RoleAssignmentB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"assignment\".\n" +
	"\x12AssignRoleResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"Z\n" +
	"\x13UnassignRoleRequest\x12C\n" +
	"\n" +
	"assignment\x18\x01 \x01(\v2\x1b.polyglot.v1.RoleAssignmentB\x06\xbaH\x03\xc8\x01\x01R\n" +
	"assignment\"0\n" +
	"\x14UnassignRoleResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\"[\n" +
	"\x1aSyncRolePermissionsRequest\x12\x1b\n" +
	...
	"\x04role\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04role\"H\n" +
